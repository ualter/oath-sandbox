...
public class OAuth2Client {
	...
	public static void main(String[] args) {
		...
		if (!OAuthUtils.isValid(username) || !OAuthUtils.isValid(password) || !OAuthUtils.isValid(authenticationServerUrl) || !OAuthUtils.isValid(grantType)) {
