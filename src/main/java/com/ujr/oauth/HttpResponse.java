...
public class HttpResponse {
	...
	public void setCode(int code) {
		...
		case 202:
			...
			break;	
		case 204:
			this.code = HttpStatus.NoContent;
			break;	
		case 400:
			this.code = HttpStatus.BadRequest;
			break;	
		case 401:
		...
		case 404:
			...
			break;	
		case 407:
			this.code = HttpStatus.ProxyAuthenticationRequired;
			break;
		case 500:
			this.code = HttpStatus.InternalServerError;
			break;	
		case 0:
			this.code = HttpStatus.Unknown;
			break;	
		default:
			break;
		}
